...
import com.rocbillow.core.assist.ActivityManager
import com.rocbillow.core.assist.AppManager
import com.rocbillow.core.assist.ContextProvider
import com.rocbillow.core.databinding.ToastViewBinding
import com.rocbillow.core.extension.inflate
import com.rocbillow.core.extension.runOnUiThread
import com.rocbillow.core.extension.screenHeight
import com.rocbillow.core.widget.toast.compat.ToastCompat
  ...
  private fun addView() {
    try {
      ...
      if (view == null) {
        ...
        viewBinding.root.background = colorParser.getBackgroundDrawable()
        viewBinding.tvMessage.apply {
          text = builder.text
          setTextColor(colorParser.getTextColor())
        }
        builder.view = view
      }
